# Simple ANN Regression Model using PyTorch (CPU) with Shapley Explanations

## Project Description

This repository is a dockerized implementation of the Simple ANN regressor using PyTorch (running on CPU). It is implemented in flexible way that it can be used with any regression dataset with the use of JSON-formatted data schema file.
...
- A **Simple ANN Regression** algorithm using PyTorch (CPU)
...
- **`src/`**: This directory holds the source code for the project. It is further divided into various subdirectories:
  ...
  - **`prediction/`**: Scripts for the Simple ANN Regression classifier model implemented in PyTorch.
